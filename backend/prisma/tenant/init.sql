...
CREATE TABLE "Configuracion" (
    ...
    "waTwilioToken" TEXT,
    "waTemplateSid" TEXT,
    "agendaWhEnabled" BOOLEAN NOT NULL DEFAULT false,
    "agendaWhConnectionId" TEXT,
    "agendaWhSecret" TEXT,
    ...
    "metaLeadAdsEnabled" BOOLEAN NOT NULL DEFAULT false,
    "metaPageId" TEXT,
    "metaPageAccessToken" TEXT,
    "metaLeadAdsUltimo" TEXT,
    "crmToken" TEXT,
...
CREATE TABLE "Lead" (
    ...
    "motivo" TEXT,
    "tratamiento" TEXT,
    "piezasReemplazar" TEXT,
    "tiempoDesdePerdida" TEXT,
