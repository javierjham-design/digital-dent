// ─────────────────────────────────────────────────────────────────────────────
//  Verticales / rubros de venta
// ─────────────────────────────────────────────────────────────────────────────
//
//  Cláriva se vende a 3 segmentos. Este módulo es la FUENTE ÚNICA de:
//   - el copy de la landing por rubro (titulares, features, testimonios),
...
export interface VerticalSeed {
  profesionales: { name: string; especialidad: string }[]
  prestaciones: { nombre: string; precio: number; duracion: number; categoria: string }[]
  motivos: string[]
}

export interface VerticalConfig {
  id: VerticalId
  nombreCorto: string        // "Dental"
  nombreLargo: string        // "Clínicas dentales"
  badge: string              // chip del hero
  headlinePre: string
  headlineHi: string         // palabra resaltada
  subtitle: string
  terminoPaciente: string    // "pacientes" | "clientes"
  terminoLugar: string       // "clínica" | "centro"
  ejemploNombre: string      // placeholder del form de demo
  features: Feature[]
  testimonios: { n: string; r: string; t: string }[]
  seed: VerticalSeed
}

// Íconos reutilizados (Heroicons outline paths).
const I = {
...
export const VERTICALES: Record<VerticalId, VerticalConfig> = {
  ...
  dental: {
    ...
    seed: {
      ...
      motivos: ['Consulta diagnóstico', 'Control', 'Detartraje / Profilaxis', 'Obturación', 'Endodoncia', 'Exodoncia', 'Ortodoncia', 'Blanqueamiento'],
    },
  },
  ...
  medico: {
    ...
    seed: {
      profesionales: [
        { name: 'Dr. Jorge Salinas', especialidad: 'Medicina general' },
        { name: 'Dra. Ana Pérez', especialidad: 'Pediatría' },
        { name: 'Dra. Lorena Díaz', especialidad: 'Nutrición' },
      ],
      prestaciones: [
        { nombre: 'Consulta medicina general', precio: 28000, duracion: 30, categoria: 'Consultas' },
        { nombre: 'Control de salud', precio: 22000, duracion: 20, categoria: 'Consultas' },
        { nombre: 'Consulta pediátrica', precio: 32000, duracion: 30, categoria: 'Pediatría' },
        { nombre: 'Control crónico (diabetes/HTA)', precio: 24000, duracion: 30, categoria: 'Crónicos' },
        { nombre: 'Electrocardiograma', precio: 18000, duracion: 20, categoria: 'Exámenes' },
        { nombre: 'Consulta nutricional', precio: 30000, duracion: 45, categoria: 'Nutrición' },
        { nombre: 'Curación simple', precio: 12000, duracion: 20, categoria: 'Procedimientos' },
        { nombre: 'Certificado médico', precio: 8000, duracion: 15, categoria: 'Administrativo' },
      ],
      motivos: ['Consulta general', 'Control de salud', 'Control crónico', 'Consulta pediátrica', 'Examen preventivo', 'Consulta nutricional', 'Certificado médico'],
    },
  },
  ...
  estetica: {
    ...
    seed: {
      profesionales: [
        { name: 'Camila Ortiz', especialidad: 'Cosmetología' },
        { name: 'Dra. Fernanda Ruiz', especialidad: 'Dermatología' },
        { name: 'Antonia Vera', especialidad: 'Depilación láser' },
      ],
      prestaciones: [
        { nombre: 'Limpieza facial profunda', precio: 35000, duracion: 60, categoria: 'Facial' },
        { nombre: 'Tratamiento facial antiedad', precio: 55000, duracion: 60, categoria: 'Facial' },
        { nombre: 'Depilación láser (zona)', precio: 40000, duracion: 30, categoria: 'Depilación' },
        { nombre: 'Masaje reductivo', precio: 30000, duracion: 45, categoria: 'Corporal' },
        { nombre: 'Radiofrecuencia corporal', precio: 60000, duracion: 60, categoria: 'Corporal' },
        { nombre: 'Peeling químico', precio: 50000, duracion: 45, categoria: 'Facial' },
        { nombre: 'Aplicación toxina botulínica', precio: 180000, duracion: 30, categoria: 'Avanzado' },
        { nombre: 'Hidratación facial', precio: 28000, duracion: 45, categoria: 'Facial' },
      ],
      motivos: ['Evaluación inicial', 'Limpieza facial', 'Depilación láser', 'Masaje reductivo', 'Radiofrecuencia', 'Control de tratamiento', 'Sesión de seguimiento'],
    },
  },
}
