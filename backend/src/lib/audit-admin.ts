...
export type AdminAction =
  ...
  | 'CAMBIAR_SLUG' | 'CONVERTIR_DEMO' | 'CAMBIAR_PAIS' | 'CAMBIAR_MODULOS' | 'CAMBIAR_PROFESIONALES_EXTRA' | 'CAMBIAR_COBRO'
  | 'RESET_PASSWORD' | 'REGISTRAR_PAGO' | 'ELIMINAR_PAGO'
  | 'CREAR_PLAN_SUSCRIPCION' | 'EDITAR_PLAN_SUSCRIPCION' | 'ELIMINAR_PLAN_SUSCRIPCION'
  | 'CREAR_EXTRA' | 'EDITAR_EXTRA' | 'ELIMINAR_EXTRA' | 'CONFIGURAR_WHATSAPP' | 'CONFIGURAR_TUBOT_WEBHOOK'
