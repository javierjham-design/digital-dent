    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50/50 to-teal-50/50">
      <header className="px-6 py-5 flex items-center justify-between max-w-6xl mx-auto">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-lg font-bold text-slate-900 tracking-tight">Plataforma Dental</span>
        </div>
      </header>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto px-6 py-8 text-center">
          <p className="text-xs text-slate-500">
            Plataforma Dental © {new Date().getFullYear()} — Multi-tenant para clínicas dentales
          </p>
        </div>
      </footer>
    </div>
