...
export const adminService = {
  ...
  tubot: (id: string) => api.get<{ hasToken: boolean }>(`/admin/clinicas/${id}/tubot`),
  rotarTubotToken: (id: string) => api.post<{ token: string }>(`/admin/clinicas/${id}/tubot/token`),
  revocarTubotToken: (id: string) => api.del<{ ok: true }>(`/admin/clinicas/${id}/tubot/token`),
  tubotWebhook: (id: string) => api.get<{ enabled: boolean; connectionId: string | null; secretConfigurado: boolean }>(`/admin/clinicas/${id}/tubot/webhook`),
  guardarTubotWebhook: (id: string, input: { enabled: boolean; connectionId: string | null; secret?: string }) => api.put<{ ok: true }>(`/admin/clinicas/${id}/tubot/webhook`, input),
