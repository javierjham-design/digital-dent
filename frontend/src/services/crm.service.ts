...
export interface CrmConfig { slug: string; metaEnabled: boolean; metaPixelId: string | null; hasCapiToken: boolean; capiTokenLen: number; capiTokenLast4: string | null; metaTestCode: string | null; testCodeActivo: boolean; testCodeHasta: string | null; crmToken: string; diasSinGestion: number; metaCrmEnabled: boolean; metaCrmDatasetId: string | null; hasCrmToken: boolean; crmTokenLast4: string | null; metaLeadAdsEnabled: boolean; metaPageId: string | null; hasPageToken: boolean; pageTokenLast4: string | null; metaLeadAdsUltimo: string | null }
